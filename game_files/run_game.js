...
const gameBox = document.getElementById('sudoku-game-box');
...
class SudokuBoard {
    constructor(gameGrid, solutionGrid) {
        ...
        this._selected;
        this._sudokuTable = document.getElementById('sudoku-grid');
	...
	_initializeSudokuBoard(gameGrid) {
		...
		for (let i=0; i < gameGrid.length; i++){
			...
			this._sudokuTable.appendChild(row);
		}
	}
...
class Game {
    ...
    resetGame() {
        ...
        const newButtons = document.createElement('table');
        newButtons.id = 'sudoku-button-container';
        const currentButtonContainer = document.getElementById('sudoku-button-container');
        currentButtonContainer.parentNode.replaceChild(newButtons, currentButtonContainer);

    }


    _getButtonPushCallback(i) {
    ...
    _initializeGame() {
        ...
        for (let i = 1; i <= 9; i++ ) {
            this.numberButtons.setClickCallback(i, this._getButtonPushCallback(i));
        }
    }
}
